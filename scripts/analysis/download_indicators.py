...
from scripts.read_data import get_indicator
...
def get_current_health_exp(*, additional_filter: dict = None) -> pd.DataFrame:
    ...
    return get_indicator(indicator, additional_filter=additional_filter)
...
def current_lcu_data(
    ...
    if additional_filter is None:
        additional_filter = {}
    full_filter = additional_filter | {"units": "current LCU"}
